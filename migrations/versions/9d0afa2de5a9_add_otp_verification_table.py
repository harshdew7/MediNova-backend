...
Revision ID: 9d0afa2de5a9
Revises: 2973350778b8
Create Date: 2026-08-20 14:00:44.089180
...
revision: str = '9d0afa2de5a9'
down_revision: Union[str, Sequence[str], None] = '2973350778b8'
...
def upgrade() -> None:
    ...
    sa.Column('email_otp_hash', sa.String(length=255), nullable=False),
    sa.Column('mobile_otp_hash', sa.String(length=255), nullable=False),
